...
/**
 * Cuckoo filter implementation. A cuckoo filter is a data structure for membership control, akin to bloom filters. But unlike bloom filters, deletions are allowed.
 * 
 * False positives are possible, false negatives are not (as long as there is not collision... if two objects have the same fingerprint and are assigned the same positions then
 * conflicts can arise).
 * @author lrodero
 *
 */
